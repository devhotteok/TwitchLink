...
class DownloadsPage(TabManager):
    ...
    def __init__(self, pageObject, parent=None):
        ...
        DownloadManager.completedSignal.connect(self.processCompleteEvent, QtCore.Qt.ConnectionType.QueuedConnection)
        DownloadManager.completedSignal.connect(self.performDownloadCompleteAction, QtCore.Qt.ConnectionType.QueuedConnection)
